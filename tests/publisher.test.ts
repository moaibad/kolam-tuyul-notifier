...
function basePosition(overrides: Partial<PositionSnapshot> = {}): PositionSnapshot {
  return {
    ...
    profitLossPercent: 6.67,
    hodlValueQuote: 30,
    lpPrincipalValueQuote: 29,
    claimedFeesValueQuote: 0,
    unclaimedFeesValueQuote: 1,
    impermanentLossQuote: -1,
    impermanentLossPercent: -3.33,
    netLpResultQuote: 0,
    netLpResultPercent: 0,
    depositedValueQuote: 30,
    activeLpValueQuote: 29,
    totalResultValueQuote: 30,
